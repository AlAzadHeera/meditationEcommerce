                    ...
                    <div class="posts-loop masonry list noo-classes row">
                        <div class="posts-loop-title">
                            ...
                            <span class="loop-view-mode">
                                <a class="grid-mode" title="Grid" href="{{ route('blogGrid') }}"><i class="fa fa-th"></i></a>
                                <a class="list-mode active" title="List"><i class="fa fa-th-list"></i></a>
                            </span>
                        </div>
                        <div class="posts-loop-content">
                            <div class="masonry-container">
                                @foreach($posts as $post)
                                    <article class="masonry-item hentry">
                                            ...
                                            <div class="loop-item-content">
                                                <div class="loop-item-content-summary">
                                                    <div class="loop-item-category">
                                                        <a href="#" rel="tag">{{ $post->category->name }}</a>
                                                    </div>
