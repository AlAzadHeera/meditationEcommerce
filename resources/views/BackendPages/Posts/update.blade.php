                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="my-editor" id="BlogDetails" name="blog_details">{!! $post->post !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="fileinput fileinput-new text-center" >
                                            <div id="avatar" class="fileinput-new thumbnail img-raised">
                                                <img src="{{ $post->fImage }}" rel="nofollow" alt="...">
                                            </div>
                                        </div>
                                        <div class="fileinput fileinput-new text-center" >
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input hidden id="thumbnail" class="form-control" type="text" name="fImage" value="{{ $post->fImage }}">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                @if($post->publish == 'publish')
                                                    <input class="form-check-input" type="checkbox" value="publish" name="publish" checked>
                                                @else
